package com.anil.hse24.base.recyclerview
 ...
 */
class CellAdapterViewHolder(val cellLayout: CellViewHolder) : RecyclerView.ViewHolder(cellLayout.rootView) {
    var cell: Cell<*>? = null
}
...
class CellRecyclerAdapter(private val mCellList: List<Cell<*>>) : RecyclerView.Adapter<CellAdapterViewHolder>() {
    ...
    override fun getItemViewType(position: Int): Int {
        ...
        val viewType: CellType = classTypeMap[cell::class] ?: CellType(++typeIdCounter, cell.viewHolderFactory)
